       class-id sodaCOBOL.menuFunctions.

       working-storage section.
           77 db           type sodaCOBOL.ConnectToServer value new type sodaCOBOL.ConnectToServer.
      ...
      * ////////////////////////////////////////////////////////////////////////////// InstanceMethod
       ...
       procedure division.
           move new type sodaCOBOL.ConnectToServer to db.
           goback.
       end method.
      * ////////////////////////////////////////////////////////////////////////////// 
      ...
      * //////////////////////////////////////////////////////////////////////////////
       ...
       procedure division returning ret.
           move db::showAsTable("SELECT id, sodaName, cancount, price, crv, worth, net, date FROM Inventory INNER JOIN Sodas ON Inventory.sodaID=Sodas.SodaID WHERE YEAR(date) = YEAR(NOW()) ORDER BY date DESC LIMIT 20;") to dt.
      ...
      * ////////////////////////////////////////////////////////////////////////////// 
       ...
       procedure division.
           ...
           move new Type List[type Int32] to intin.
           invoke db::insert("Spendings", col2, strin, douin2, intin, bolin, tdat).
           goback.
       getSodas.
           try
       ...
       getPPunit.
           try
               ...
               if price > 5
                   invoke douin::Add(1.2)
                   invoke douin::Add(12)
                   compute price = 12 - (Price + 1.2)
                   invoke douin::Add(price)
                   invoke intin::Add(24)
               else
                   invoke douin::Add(0.6)
                   invoke douin::Add(6)
                   compute price = 6 - (Price + 0.6)
                   invoke douin::Add(price)
                   invoke intin::Add(12)
               end-if
               invoke tdat::Add(type DateTime::Now)
               invoke db::insert("Inventory", coln, strin, douin, intin, bolin, tdat)
               move false to continAdd
           catch ex
           end-try.
       end method.
      * ////////////////////////////////////////////////////////////////////////////// 
       ...
       procedure division.
           ...
           invoke db::insert("CashOut", coln, strin, douin, intin, bolin, datin)
           goback.
       end method.
      * ///////////////////////////////////////////////////////////////////////////////
       ...
       procedure division.
           ...
           display "-----------------------------".
           move db::showAsTable("SELECT Ernings, date FROM CashOut WHERE YEAR(date) = YEAR(NOW());") to tabl.
      ...
      * ///////////////////////////////////////////////////////////////////////////////
       ...
       procedure division.
           ...
           display "-----------------------------".
           move db::showAsTable("SELECT price, date FROM Spendings WHERE YEAR(date) = YEAR(NOW());") to tabl.
      ...
      * ///////////////////////////////////////////////////////////////////////////////
       ...
       procedure division.
           ...
           display "------------------------------------------------"
           move db::showAsTable("SELECT SodaName, cancount, (price+crv) AS 'Price', worth FROM Inventory INNER JOIN Sodas ON Sodas.SodaID = Inventory.SodaID WHERE date > ADDDATE(NOW(), -31);") to tabl.
      ...
      * ///////////////////////////////////////////////////////////////////////////////
       ...
       procedure division.
           ...
           move db::showAsTable
           ("SELECT SodaName, (Price + crv), cancount, ((Price + crv) / cancount), Worth, (Worth - (Price + crv)) FROM Inventory INNER JOIN Sodas ON Sodas.SodaID = Inventory.sodaID WHERE YEAR(date) = YEAR(NOW()) ORDER BY Inventory.id DESC;") 
           to tabl.
      ...
      * //////////////////////////////////////////////////////////////////////////////////////////////////////
       ...
       procedure division.
           move db::showAsList("SELECT ernings FROM CashOut WHERE YEAR(date) = YEAR(NOW());") to spending.
           invoke type Console::Clear().
      ...
      * ///////////////////////////////////////////////////////////////////////////////////////////////////////////////
       ...
       procedure division.
           move db::showAsList("SELECT price From Spendings WHERE YEAR(date) = YEAR(NOW());") to spending.
           move db::showAsList("SELECT ernings FROM CashOut WHERE YEAR(date) = YEAR(NOW());") to earnings.
           invoke type Console::Clear().
      ...
      * /////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        local-storage section.
           77 weekSodaEarn         type Double value 0.
           77 cancount             type Int32 value 0.
           77 tb                   type System.Data.DataTable value new System.Data.DataTable.
           77 idx                  pic 9(13).
        procedure division.
           invoke type Console::Clear().
           move db::showAsTable("select SUM(cancount), SUM(worth) FROM Inventory WHERE YEAR(date) = YEAR(NOW()) GROUP BY date;") to tb.
